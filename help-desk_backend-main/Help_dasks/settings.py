...
DATABASES = {
   'default': {
       ...
       # Matches the postgres service's POSTGRES_DB/USER/PASSWORD in docker-compose.yaml.
       'NAME': 'db_helpDesk',
       'USER': 'postgres',
       'PASSWORD': 'root',
       # Service name on the compose network, not the app container's own loopback.
